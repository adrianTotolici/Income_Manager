...
/**
 *
 * LayeredGradientPanel.java <p/> An example of for custom Layered Gradient
 * JPanel.
 *
 * @author JDhilsukh
 *
...
public class LayeredGradientPanel extends JPanel {
    ...
    public void paintComponent(Graphics g2) {
        ...
        g.fill(shape);
        paint = new Color(0, 0, 0, 255);
        shape = new RoundRectangle2D.Double(1, 1, width - 2, height - 2, 15.0,
                15.0);
        g.setPaint(paint);
        ...
        g.setStroke(stroke);
        g.draw(shape);
        paint = new LinearGradientPaint(new Point2D.Double(321.125,
                205.1853790283203), new Point2D.Double(321.125, 300.3125),
                ...
                1.0f, 0.0f, 0.0f, 1.0f, -189.4317169189453f,
                -220.40145874023438f));
