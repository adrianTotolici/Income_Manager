 ...
 */
package eu.IncomeManager.GUI.customButtons.custom.component.button;
...
import eu.IncomeManager.GUI.customButtons.util.*;
...
public class GlossyButton extends JButton {
     ...
     *            label on the button
     */
    public GlossyButton(String text, ImageIcon icon) {
        super(text,icon);
        init();
    }
     ...
     *            button theme.
     */
    public GlossyButton(String text, int buttonTheme, ImageIcon icon) {
        super(text,icon);
        this.buttonTheme = buttonTheme;
        init();
    }
     ...
     *            shape of the button
     */
    public GlossyButton(String text, String buttonType, ImageIcon icon) {
        super(text,icon);
        this.buttonType = buttonType;
        init();
    }
     ...
     *            shape of the button
     */
    public GlossyButton(String text, int buttonTheme, String buttonType, ImageIcon icon) {
        super(text,icon);
        this.buttonTheme = buttonTheme;
        this.buttonType = buttonType;
        init();
     ...
     */
    public GlossyButton(String text, String buttonType, int buttonTheme,
                        int rolloverTheme, ImageIcon icon) {
        super(text,icon);
        this.buttonType = buttonType;
        this.buttonTheme = buttonTheme;
        this.rollOverTheme = rolloverTheme;
     ...
     */
    public GlossyButton(String text, String buttonType, int buttonTheme,
                        int rolloverTheme, int selectedTheme, ImageIcon icon) {
        super(text,icon);
        this.buttonTheme = buttonTheme;
        this.buttonType = buttonType;
        this.rollOverTheme = rolloverTheme;
