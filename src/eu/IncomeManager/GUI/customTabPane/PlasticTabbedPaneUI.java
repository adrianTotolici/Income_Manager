package eu.IncomeManager.GUI.customTabPane;
...
public class PlasticTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    /**
     * En este poligono se guarda la forma de la pestańa. Es muy importante.
     */
    ...
    protected void paintTabBackground( Graphics g, int tabPlacement,
        ...
        // Encima, pintamos la pestańa con el color que sea
        g2D.fill( shape);

        // Encima, pintamos la pestańa con el color que le corresponde por profundidad
        if ( runCount > 1 ) {
            g2D.setColor( hazAlfa( getRunForTab( tabPane.getTabCount(), tabIndex)-1));
            g2D.fill( shape);
        }

        // Y despues, le damos un sombreado que hace que parezca curbada (żA que duele ver algunas faltas de ortografia?)

        g2D.fill( shape);
    }

    /**
     * Este metodo devuelve un tamańo mas grande de lo necesario, haciendoer hueco para
     * la decoracion.
     */
    ...
    /**
     * Este metodo devuelve un tamańo mas grande de lo necesario, haciendo el hueco para
     * la decoracion.
     */
    ...
    /**
     * Este metodo dibuja una seńal amarilla en la solapa que tiene el foco
     */
